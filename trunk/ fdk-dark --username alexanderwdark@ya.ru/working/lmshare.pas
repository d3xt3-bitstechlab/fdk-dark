...
type
  TNetShareAdd = function(servername: LPWSTR; level: DWORD;
    const buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;

  TNetShareEnum = function(servername: LPWSTR; level: DWORD;
    var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

  TNetShareEnumSticky = function(servername: LPWSTR; level: DWORD;
    var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
    var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

  TNetShareGetInfo = function(servername: LPWSTR; netname: LPWSTR;
    level: DWORD; var butptr: Pointer): NET_API_STATUS; stdcall;

  TNetShareSetInfo = function(servername: LPWSTR; netname: LPWSTR;
    leve: DWORD; const buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;
...
function NetShareSetInfo(servername: LPWSTR; netname: LPWSTR;
  leve: DWORD; const buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;
...
type
  ...
  TNetFileEnum = function(servername: LPWSTR; basepath: LPWSTR;
    username: LPWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
    var entriesread: DWORD; var totalentries: DWORD;
    resume_handle: PDWORD): NET_API_STATUS; stdcall;

  TNetFileGetInfo = function(servername: LPWSTR; fileid: DWORD;
