{$DEFINE LANMAN_INCLUDE_ERRTEXTS}
unit LmUtils;
...
const
  ...
  sNERR_ServiceCtlNotValid =
    'The requested pause or stop is not valid for this service.';
  sNERR_NotInDispatchTbl =
  ...
  sNERR_RplAdapterNameUnavailable =
  ...
  sNERR_DfsVolumeHasMultipleServers =
  ...
  sNERR_NameUsesIncompatibleCodePage =
...
begin
  case ErrorCode of
    NERR_NetNotStarted:
      Result := sNERR_NetNotStarted;
    NERR_UnknownServer:
      Result := sNERR_UnknownServer;
    NERR_ShareMem:
      Result := sNERR_ShareMem;
    NERR_NoNetworkResource:
      Result := sNERR_NoNetworkResource;
    NERR_RemoteOnly:
      Result := sNERR_RemoteOnly;
    NERR_DevNotRedirected:
      Result := sNERR_DevNotRedirected;
    NERR_ServerNotStarted:
      Result := sNERR_ServerNotStarted;
    NERR_ItemNotFound:
      Result := sNERR_ItemNotFound;
    NERR_UnknownDevDir:
      Result := sNERR_UnknownDevDir;
    NERR_RedirectedPath:
      Result := sNERR_RedirectedPath;
    NERR_DuplicateShare:
      Result := sNERR_DuplicateShare;
    NERR_NoRoom:
      Result := sNERR_NoRoom;
    NERR_TooManyItems:
      Result := sNERR_TooManyItems;
    NERR_InvalidMaxUsers:
      Result := sNERR_InvalidMaxUsers;
    NERR_BufTooSmall:
      Result := sNERR_BufTooSmall;
    NERR_RemoteErr:
      Result := sNERR_RemoteErr;
    NERR_LanmanIniError:
      Result := sNERR_LanmanIniError;
    NERR_NetworkError:
      Result := sNERR_NetworkError;
    NERR_WkstaInconsistentState:
      Result := sNERR_WkstaInconsistentState;
    NERR_WkstaNotStarted:
      Result := sNERR_WkstaNotStarted;
    NERR_BrowserNotStarted:
      Result := sNERR_BrowserNotStarted;
    NERR_InternalError:
      Result := sNERR_InternalError;
    NERR_BadTransactConfig:
      Result := sNERR_BadTransactConfig;
    NERR_InvalidAPI:
      Result := sNERR_InvalidAPI;
    NERR_BadEventName:
      Result := sNERR_BadEventName;
    NERR_DupNameReboot:
      Result := sNERR_DupNameReboot;
    NERR_CfgCompNotFound:
      Result := sNERR_CfgCompNotFound;
    NERR_CfgParamNotFound:
      Result := sNERR_CfgParamNotFound;
    NERR_LineTooLong:
      Result := sNERR_LineTooLong;
    NERR_QNotFound:
      Result := sNERR_QNotFound;
    NERR_JobNotFound:
      Result := sNERR_JobNotFound;
    NERR_DestNotFound:
      Result := sNERR_DestNotFound;
    NERR_DestExists:
      Result := sNERR_DestExists;
    NERR_QExists:
      Result := sNERR_QExists;
    NERR_QNoRoom:
      Result := sNERR_QNoRoom;
    NERR_JobNoRoom:
      Result := sNERR_JobNoRoom;
    NERR_DestNoRoom:
      Result := sNERR_DestNoRoom;
    NERR_DestIdle:
      Result := sNERR_DestIdle;
    NERR_DestInvalidOp:
      Result := sNERR_DestInvalidOp;
    NERR_ProcNoRespond:
      Result := sNERR_ProcNoRespond;
    NERR_SpoolerNotLoaded:
      Result := sNERR_SpoolerNotLoaded;
    NERR_DestInvalidState:
      Result := sNERR_DestInvalidState;
    NERR_QInvalidState:
      Result := sNERR_QInvalidState;
    NERR_JobInvalidState:
      Result := sNERR_JobInvalidState;
    NERR_SpoolNoMemory:
      Result := sNERR_SpoolNoMemory;
    NERR_DriverNotFound:
      Result := sNERR_DriverNotFound;
    NERR_DataTypeInvalid:
      Result := sNERR_DataTypeInvalid;
    NERR_ProcNotFound:
      Result := sNERR_ProcNotFound;
    NERR_ServiceTableLocked:
      Result := sNERR_ServiceTableLocked;
    NERR_ServiceTableFull:
      Result := sNERR_ServiceTableFull;
    NERR_ServiceInstalled:
      Result := sNERR_ServiceInstalled;
    NERR_ServiceEntryLocked:
      Result := sNERR_ServiceEntryLocked;
    NERR_ServiceNotInstalled:
      Result := sNERR_ServiceNotInstalled;
    NERR_BadServiceName:
      Result := sNERR_BadServiceName;
    NERR_ServiceCtlTimeout:
      Result := sNERR_ServiceCtlTimeout;
    NERR_ServiceCtlBusy:
      Result := sNERR_ServiceCtlBusy;
    NERR_BadServiceProgName:
      Result := sNERR_BadServiceProgName;
    NERR_ServiceNotCtrl:
      Result := sNERR_ServiceNotCtrl;
    NERR_ServiceKillProc:
      Result := sNERR_ServiceKillProc;
    NERR_ServiceCtlNotValid:
      Result := sNERR_ServiceCtlNotValid;
    NERR_NotInDispatchTbl:
      Result := sNERR_NotInDispatchTbl;
    NERR_BadControlRecv:
      Result := sNERR_BadControlRecv;
    NERR_ServiceNotStarting:
      Result := sNERR_ServiceNotStarting;
    NERR_AlreadyLoggedOn:
      Result := sNERR_AlreadyLoggedOn;
    NERR_NotLoggedOn:
      Result := sNERR_NotLoggedOn;
    NERR_BadUsername:
      Result := sNERR_BadUsername;
    NERR_BadPassword:
      Result := sNERR_BadPassword;
    NERR_UnableToAddName_W:
      Result := sNERR_UnableToAddName_W;
    NERR_UnableToAddName_F:
      Result := sNERR_UnableToAddName_F;
    NERR_UnableToDelName_W:
      Result := sNERR_UnableToDelName_W;
    NERR_UnableToDelName_F:
      Result := sNERR_UnableToDelName_F;
    NERR_LogonsPaused:
      Result := sNERR_LogonsPaused;
    NERR_LogonServerConflict:
      Result := sNERR_LogonServerConflict;
    NERR_LogonNoUserPath:
      Result := sNERR_LogonNoUserPath;
    NERR_LogonScriptError:
      Result := sNERR_LogonScriptError;
    NERR_StandaloneLogon:
      Result := sNERR_StandaloneLogon;
    NERR_LogonServerNotFound:
      Result := sNERR_LogonServerNotFound;
    NERR_LogonDomainExists:
      Result := sNERR_LogonDomainExists;
    NERR_NonValidatedLogon:
      Result := sNERR_NonValidatedLogon;
    NERR_ACFNotFound:
      Result := sNERR_ACFNotFound;
    NERR_GroupNotFound:
      Result := sNERR_GroupNotFound;
    NERR_UserNotFound:
      Result := sNERR_UserNotFound;
    NERR_ResourceNotFound:
      Result := sNERR_ResourceNotFound;
    NERR_GroupExists:
      Result := sNERR_GroupExists;
    NERR_UserExists:
      Result := sNERR_UserExists;
    NERR_ResourceExists:
      Result := sNERR_ResourceExists;
    NERR_NotPrimary:
      Result := sNERR_NotPrimary;
    NERR_ACFNotLoaded:
      Result := sNERR_ACFNotLoaded;
    NERR_ACFNoRoom:
      Result := sNERR_ACFNoRoom;
    NERR_ACFFileIOFail:
      Result := sNERR_ACFFileIOFail;
    NERR_ACFTooManyLists:
      Result := sNERR_ACFTooManyLists;
    NERR_UserLogon:
      Result := sNERR_UserLogon;
    NERR_ACFNoParent:
      Result := sNERR_ACFNoParent;
    NERR_CanNotGrowSegment:
      Result := sNERR_CanNotGrowSegment;
    NERR_SpeGroupOp:
      Result := sNERR_SpeGroupOp;
    NERR_NotInCache:
      Result := sNERR_NotInCache;
    NERR_UserInGroup:
      Result := sNERR_UserInGroup;
    NERR_UserNotInGroup:
      Result := sNERR_UserNotInGroup;
    NERR_AccountUndefined:
      Result := sNERR_AccountUndefined;
    NERR_AccountExpired:
      Result := sNERR_AccountExpired;
    NERR_InvalidWorkstation:
      Result := sNERR_InvalidWorkstation;
    NERR_InvalidLogonHours:
      Result := sNERR_InvalidLogonHours;
    NERR_PasswordExpired:
      Result := sNERR_PasswordExpired;
    NERR_PasswordCantChange:
      Result := sNERR_PasswordCantChange;
    NERR_PasswordHistConflict:
      Result := sNERR_PasswordHistConflict;
    NERR_PasswordTooShort:
      Result := sNERR_PasswordTooShort;
    NERR_PasswordTooRecent:
      Result := sNERR_PasswordTooRecent;
    NERR_InvalidDatabase:
      Result := sNERR_InvalidDatabase;
    NERR_DatabaseUpToDate:
      Result := sNERR_DatabaseUpToDate;
    NERR_SyncRequired:
      Result := sNERR_SyncRequired;
    NERR_UseNotFound:
      Result := sNERR_UseNotFound;
    NERR_BadAsgType:
      Result := sNERR_BadAsgType;
    NERR_DeviceIsShared:
      Result := sNERR_DeviceIsShared;
    NERR_NoComputerName:
      Result := sNERR_NoComputerName;
    NERR_MsgAlreadyStarted:
      Result := sNERR_MsgAlreadyStarted;
    NERR_MsgInitFailed:
      Result := sNERR_MsgInitFailed;
    NERR_NameNotFound:
      Result := sNERR_NameNotFound;
    NERR_AlreadyForwarded:
      Result := sNERR_AlreadyForwarded;
    NERR_AddForwarded:
      Result := sNERR_AddForwarded;
    NERR_AlreadyExists:
      Result := sNERR_AlreadyExists;
    NERR_TooManyNames:
      Result := sNERR_TooManyNames;
    NERR_DelComputerName:
      Result := sNERR_DelComputerName;
    NERR_LocalForward:
      Result := sNERR_LocalForward;
    NERR_GrpMsgProcessor:
      Result := sNERR_GrpMsgProcessor;
    NERR_PausedRemote:
      Result := sNERR_PausedRemote;
    NERR_BadReceive:
      Result := sNERR_BadReceive;
    NERR_NameInUse:
      Result := sNERR_NameInUse;
    NERR_MsgNotStarted:
      Result := sNERR_MsgNotStarted;
    NERR_NotLocalName:
      Result := sNERR_NotLocalName;
    NERR_NoForwardName:
      Result := sNERR_NoForwardName;
    NERR_RemoteFull:
      Result := sNERR_RemoteFull;
    NERR_NameNotForwarded:
      Result := sNERR_NameNotForwarded;
    NERR_TruncatedBroadcast:
      Result := sNERR_TruncatedBroadcast;
    NERR_InvalidDevice:
      Result := sNERR_InvalidDevice;
    NERR_WriteFault:
      Result := sNERR_WriteFault;
    NERR_DuplicateName:
      Result := sNERR_DuplicateName;
    NERR_DeleteLater:
      Result := sNERR_DeleteLater;
    NERR_IncompleteDel:
      Result := sNERR_IncompleteDel;
    NERR_MultipleNets:
      Result := sNERR_MultipleNets;
    NERR_NetNameNotFound:
      Result := sNERR_NetNameNotFound;
    NERR_DeviceNotShared:
      Result := sNERR_DeviceNotShared;
    NERR_ClientNameNotFound:
      Result := sNERR_ClientNameNotFound;
    NERR_FileIdNotFound:
      Result := sNERR_FileIdNotFound;
    NERR_ExecFailure:
      Result := sNERR_ExecFailure;
    NERR_TmpFile:
      Result := sNERR_TmpFile;
    NERR_TooMuchData:
      Result := sNERR_TooMuchData;
    NERR_DeviceShareConflict:
      Result := sNERR_DeviceShareConflict;
    NERR_BrowserTableIncomplete:
      Result := sNERR_BrowserTableIncomplete;
    NERR_NotLocalDomain:
      Result := sNERR_NotLocalDomain;
    NERR_IsDfsShare:
      Result := sNERR_IsDfsShare;
    NERR_DevInvalidOpCode:
      Result := sNERR_DevInvalidOpCode;
    NERR_DevNotFound:
      Result := sNERR_DevNotFound;
    NERR_DevNotOpen:
      Result := sNERR_DevNotOpen;
    NERR_BadQueueDevString:
      Result := sNERR_BadQueueDevString;
    NERR_BadQueuePriority:
      Result := sNERR_BadQueuePriority;
    NERR_NoCommDevs:
      Result := sNERR_NoCommDevs;
    NERR_QueueNotFound:
      Result := sNERR_QueueNotFound;
    NERR_BadDevString:
      Result := sNERR_BadDevString;
    NERR_BadDev:
      Result := sNERR_BadDev;
    NERR_InUseBySpooler:
      Result := sNERR_InUseBySpooler;
    NERR_CommDevInUse:
      Result := sNERR_CommDevInUse;
    NERR_InvalidComputer:
      Result := sNERR_InvalidComputer;
    NERR_MaxLenExceeded:
      Result := sNERR_MaxLenExceeded;
    NERR_BadComponent:
      Result := sNERR_BadComponent;
    NERR_CantType:
      Result := sNERR_CantType;
    NERR_TooManyEntries:
      Result := sNERR_TooManyEntries;
    NERR_ProfileFileTooBig:
      Result := sNERR_ProfileFileTooBig;
    NERR_ProfileOffset:
      Result := sNERR_ProfileOffset;
    NERR_ProfileCleanup:
      Result := sNERR_ProfileCleanup;
    NERR_ProfileUnknownCmd:
      Result := sNERR_ProfileUnknownCmd;
    NERR_ProfileLoadErr:
      Result := sNERR_ProfileLoadErr;
    NERR_ProfileSaveErr:
      Result := sNERR_ProfileSaveErr;
    NERR_LogOverflow:
      Result := sNERR_LogOverflow;
    NERR_LogFileChanged:
      Result := sNERR_LogFileChanged;
    NERR_LogFileCorrupt:
      Result := sNERR_LogFileCorrupt;
    NERR_SourceIsDir:
      Result := sNERR_SourceIsDir;
    NERR_BadSource:
      Result := sNERR_BadSource;
    NERR_BadDest:
      Result := sNERR_BadDest;
    NERR_DifferentServers:
      Result := sNERR_DifferentServers;
    NERR_RunSrvPaused:
      Result := sNERR_RunSrvPaused;
    NERR_ErrCommRunSrv:
      Result := sNERR_ErrCommRunSrv;
    NERR_ErrorExecingGhost:
      Result := sNERR_ErrorExecingGhost;
    NERR_ShareNotFound:
      Result := sNERR_ShareNotFound;
    NERR_InvalidLana:
      Result := sNERR_InvalidLana;
    NERR_OpenFiles:
      Result := sNERR_OpenFiles;
    NERR_ActiveConns:
      Result := sNERR_ActiveConns;
    NERR_BadPasswordCore:
      Result := sNERR_BadPasswordCore;
    NERR_DevInUse:
      Result := sNERR_DevInUse;
    NERR_LocalDrive:
      Result := sNERR_LocalDrive;
    NERR_AlertExists:
      Result := sNERR_AlertExists;
    NERR_TooManyAlerts:
      Result := sNERR_TooManyAlerts;
    NERR_NoSuchAlert:
      Result := sNERR_NoSuchAlert;
    NERR_BadRecipient:
      Result := sNERR_BadRecipient;
    NERR_AcctLimitExceeded:
      Result := sNERR_AcctLimitExceeded;
    NERR_InvalidLogSeek:
      Result := sNERR_InvalidLogSeek;
    NERR_BadUasConfig:
      Result := sNERR_BadUasConfig;
    NERR_InvalidUASOp:
      Result := sNERR_InvalidUASOp;
    NERR_LastAdmin:
      Result := sNERR_LastAdmin;
    NERR_DCNotFound:
      Result := sNERR_DCNotFound;
    NERR_LogonTrackingError:
      Result := sNERR_LogonTrackingError;
    NERR_NetlogonNotStarted:
      Result := sNERR_NetlogonNotStarted;
    NERR_CanNotGrowUASFile:
      Result := sNERR_CanNotGrowUASFile;
    NERR_TimeDiffAtDC:
      Result := sNERR_TimeDiffAtDC;
    NERR_PasswordMismatch:
      Result := sNERR_PasswordMismatch;
    NERR_NoSuchServer:
      Result := sNERR_NoSuchServer;
    NERR_NoSuchSession:
      Result := sNERR_NoSuchSession;
    NERR_NoSuchConnection:
      Result := sNERR_NoSuchConnection;
    NERR_TooManyServers:
      Result := sNERR_TooManyServers;
    NERR_TooManySessions:
      Result := sNERR_TooManySessions;
    NERR_TooManyConnections:
      Result := sNERR_TooManyConnections;
    NERR_TooManyFiles:
      Result := sNERR_TooManyFiles;
    NERR_NoAlternateServers:
      Result := sNERR_NoAlternateServers;
    NERR_TryDownLevel:
      Result := sNERR_TryDownLevel;
    NERR_UPSDriverNotStarted:
      Result := sNERR_UPSDriverNotStarted;
    NERR_UPSInvalidConfig:
      Result := sNERR_UPSInvalidConfig;
    NERR_UPSInvalidCommPort:
      Result := sNERR_UPSInvalidCommPort;
    NERR_UPSSignalAsserted:
      Result := sNERR_UPSSignalAsserted;
    NERR_UPSShutdownFailed:
      Result := sNERR_UPSShutdownFailed;
    NERR_BadDosRetCode:
      Result := sNERR_BadDosRetCode;
    NERR_ProgNeedsExtraMem:
      Result := sNERR_ProgNeedsExtraMem;
    NERR_BadDosFunction:
      Result := sNERR_BadDosFunction;
    NERR_RemoteBootFailed:
      Result := sNERR_RemoteBootFailed;
    NERR_BadFileCheckSum:
      Result := sNERR_BadFileCheckSum;
    NERR_NoRplBootSystem:
      Result := sNERR_NoRplBootSystem;
    NERR_RplLoadrNetBiosErr:
      Result := sNERR_RplLoadrNetBiosErr;
    NERR_RplLoadrDiskErr:
      Result := sNERR_RplLoadrDiskErr;
    NERR_ImageParamErr:
      Result := sNERR_ImageParamErr;
    NERR_TooManyImageParams:
      Result := sNERR_TooManyImageParams;
    NERR_NonDosFloppyUsed:
      Result := sNERR_NonDosFloppyUsed;
    NERR_RplBootRestart:
      Result := sNERR_RplBootRestart;
    NERR_RplSrvrCallFailed:
      Result := sNERR_RplSrvrCallFailed;
    NERR_CantConnectRplSrvr:
      Result := sNERR_CantConnectRplSrvr;
    NERR_CantOpenImageFile:
      Result := sNERR_CantOpenImageFile;
    NERR_CallingRplSrvr:
      Result := sNERR_CallingRplSrvr;
    NERR_StartingRplBoot:
      Result := sNERR_StartingRplBoot;
    NERR_RplBootServiceTerm:
      Result := sNERR_RplBootServiceTerm;
    NERR_RplBootStartFailed:
      Result := sNERR_RplBootStartFailed;
    NERR_RPL_CONNECTED:
      Result := sNERR_RPL_CONNECTED;
    NERR_BrowserConfiguredToNotRun:
      Result := sNERR_BrowserConfiguredToNotRun;
    NERR_RplNoAdaptersStarted:
      Result := sNERR_RplNoAdaptersStarted;
    NERR_RplBadRegistry:
      Result := sNERR_RplBadRegistry;
    NERR_RplBadDatabase:
      Result := sNERR_RplBadDatabase;
    NERR_RplRplfilesShare:
      Result := sNERR_RplRplfilesShare;
    NERR_RplNotRplServer:
      Result := sNERR_RplNotRplServer;
    NERR_RplCannotEnum:
      Result := sNERR_RplCannotEnum;
    NERR_RplWkstaInfoCorrupted:
      Result := sNERR_RplWkstaInfoCorrupted;
    NERR_RplWkstaNotFound:
      Result := sNERR_RplWkstaNotFound;
    NERR_RplWkstaNameUnavailable:
      Result := sNERR_RplWkstaNameUnavailable;
    NERR_RplProfileInfoCorrupted:
      Result := sNERR_RplProfileInfoCorrupted;
    NERR_RplProfileNotFound:
      Result := sNERR_RplProfileNotFound;
    NERR_RplProfileNameUnavailable:
      Result := sNERR_RplProfileNameUnavailable;
    NERR_RplProfileNotEmpty:
      Result := sNERR_RplProfileNotEmpty;
    NERR_RplConfigInfoCorrupted:
      Result := sNERR_RplConfigInfoCorrupted;
    NERR_RplConfigNotFound:
      Result := sNERR_RplConfigNotFound;
    NERR_RplAdapterInfoCorrupted:
      Result := sNERR_RplAdapterInfoCorrupted;
    NERR_RplInternal:
      Result := sNERR_RplInternal;
    NERR_RplVendorInfoCorrupted:
      Result := sNERR_RplVendorInfoCorrupted;
    NERR_RplBootInfoCorrupted:
      Result := sNERR_RplBootInfoCorrupted;
    NERR_RplWkstaNeedsUserAcct:
      Result := sNERR_RplWkstaNeedsUserAcct;
    NERR_RplNeedsRPLUSERAcct:
      Result := sNERR_RplNeedsRPLUSERAcct;
    NERR_RplBootNotFound:
      Result := sNERR_RplBootNotFound;
    NERR_RplIncompatibleProfile:
      Result := sNERR_RplIncompatibleProfile;
    NERR_RplAdapterNameUnavailable:
      Result := sNERR_RplAdapterNameUnavailable;
    NERR_RplConfigNotEmpty:
      Result := sNERR_RplConfigNotEmpty;
    NERR_RplBootInUse:
      Result := sNERR_RplBootInUse;
    NERR_RplBackupDatabase:
      Result := sNERR_RplBackupDatabase;
    NERR_RplAdapterNotFound:
      Result := sNERR_RplAdapterNotFound;
    NERR_RplVendorNotFound:
      Result := sNERR_RplVendorNotFound;
    NERR_RplVendorNameUnavailable:
      Result := sNERR_RplVendorNameUnavailable;
    NERR_RplBootNameUnavailable:
      Result := sNERR_RplBootNameUnavailable;
    NERR_RplConfigNameUnavailable:
      Result := sNERR_RplConfigNameUnavailable;
    NERR_DfsInternalCorruption:
      Result := sNERR_DfsInternalCorruption;
    NERR_DfsVolumeDataCorrupt:
      Result := sNERR_DfsVolumeDataCorrupt;
    NERR_DfsNoSuchVolume:
      Result := sNERR_DfsNoSuchVolume;
    NERR_DfsVolumeAlreadyExists:
      Result := sNERR_DfsVolumeAlreadyExists;
    NERR_DfsAlreadyShared:
      Result := sNERR_DfsAlreadyShared;
    NERR_DfsNoSuchShare:
      Result := sNERR_DfsNoSuchShare;
    NERR_DfsNotALeafVolume:
      Result := sNERR_DfsNotALeafVolume;
    NERR_DfsLeafVolume:
      Result := sNERR_DfsLeafVolume;
    NERR_DfsVolumeHasMultipleServers:
      Result := sNERR_DfsVolumeHasMultipleServers;
    NERR_DfsCantCreateJunctionPoint:
      Result := sNERR_DfsCantCreateJunctionPoint;
    NERR_DfsServerNotDfsAware:
      Result := sNERR_DfsServerNotDfsAware;
    NERR_DfsBadRenamePath:
      Result := sNERR_DfsBadRenamePath;
    NERR_DfsVolumeIsOffline:
      Result := sNERR_DfsVolumeIsOffline;
    NERR_DfsNoSuchServer:
      Result := sNERR_DfsNoSuchServer;
    NERR_DfsCyclicalName:
      Result := sNERR_DfsCyclicalName;
    NERR_DfsNotSupportedInServerDfs:
      Result := sNERR_DfsNotSupportedInServerDfs;
    NERR_DfsDuplicateService:
      Result := sNERR_DfsDuplicateService;
    NERR_DfsCantRemoveLastServerShare:
      Result := sNERR_DfsCantRemoveLastServerShare;
    NERR_DfsVolumeIsInterDfs:
      Result := sNERR_DfsVolumeIsInterDfs;
    NERR_DfsInconsistent:
      Result := sNERR_DfsInconsistent;
    NERR_DfsServerUpgraded:
      Result := sNERR_DfsServerUpgraded;
    NERR_DfsDataIsIdentical:
      Result := sNERR_DfsDataIsIdentical;
    NERR_DfsCantRemoveDfsRoot:
      Result := sNERR_DfsCantRemoveDfsRoot;
    NERR_DfsChildOrParentInDfs:
      Result := sNERR_DfsChildOrParentInDfs;
    NERR_DfsInternalError:
      Result := sNERR_DfsInternalError;
    NERR_SetupAlreadyJoined:
      Result := sNERR_SetupAlreadyJoined;
    NERR_SetupNotJoined:
      Result := sNERR_SetupNotJoined;
    NERR_SetupDomainController:
      Result := sNERR_SetupDomainController;
    NERR_DefaultJoinRequired:
      Result := sNERR_DefaultJoinRequired;
    NERR_InvalidWorkgroupName:
      Result := sNERR_InvalidWorkgroupName;
    NERR_NameUsesIncompatibleCodePage:
      Result := sNERR_NameUsesIncompatibleCodePage;
    NERR_ComputerAccountNotFound:
      Result := sNERR_ComputerAccountNotFound;
    else
      Result := '';
  end;
end;
...
begin
  ...
  begin
    Error := EWin32Error.CreateFmt(sNetError, [RetCode, SysAndNetErrorMessage(RetCode)]);
